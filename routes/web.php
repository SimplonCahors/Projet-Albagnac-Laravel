...
Route::post('/dso/{idDso}/devis/e/edit', 'DevisEController@edit')->name('devis-e-edit');
Route::get('/dso/{idDso}/devis/e/update', 'DevisEController@update')->name('devis-e-update');
