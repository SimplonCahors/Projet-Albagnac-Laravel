	...
	<form action="/dso/{{$idDso}}/emballages/{{ $idEmballage }}/edit/" method="POST">
		...
		<div id="left">
			...
			<div class="form-group row">
				<div class="col-6">
					<input type="text" class="form-control" name="ref_int" value="{{ $data->ref_int }}">
				</div>
			...
			<div class="form-group row">
				<div class="col-6">
					<input type="text" class="form-control" name="ref_ext" value="{{ $data->ref_ext }}">
				</div>
			...
			<div class="form-group row">
				<div class="col-6">
					<select class="form-control" name="forme" value="{{ $data->forme }}">
						<option selected>{{ $data->forme }}</option>
			...
			<div class="form-group row">
				<div class="col-6">
					<input type="number" class="form-control" min="0" name="hauteur" value="{{ $data->hauteur }}">
				</div>
			...
			<div class="form-group row">
				<div class="col-6">
					<input type="number" class="form-control" min="0" name="diametre_longueur" value="{{ $data->diametre_longueur }}">
				</div>
				<label for="diametre_longueur" class="col-6 col-form-label">Diamètre en mm</label>
			</div>

			<div class="form-group">
				<textarea class="form-control" name="observations" rows="3" placeholder="Observations">{{ $data->observations }}
				</textarea>
			</div>
		...
		<div id="right">
			...
			<div class="form-group row">
				<div class="col-5">
					<select class="form-control" name="plein_vide" value="{{ $data->plein_vide }}" >
						<option selected>{{ $data->plein_vide }}</option>
			...
			<div class="form-group row">
				<div class="col-5">
					<input type="number" class="form-control" name="temp_produit" value="{{ $data->temp_produit }}">
				</div>
			...
			<div class="form-group row">
				<div class="col-5">
					<input type="number" class="form-control" min="0" name="poids_prod" value="{{ $data->poids_prod }}">
				</div>
			...
			<div class="form-group row">
				<div class="col-5">
					<select class="form-control" name="matiere" value="{{ $data->matiere }}">
						<option selected>{{ $data->matiere }}</option>
			...
			<div class="form-group row">
				<div class="col-5">
					<select class="form-control" name="niveau_deform" value="{{ $data->niveau_deform }}">
						<option selected>{{ $data->niveau_deform }}</option>
			...
			<div class="form-group row">
				<div class="col-5">
					<input type="text" class="form-control" name="tolerance_dim" value="{{ $data->tolerance_dim }}">
				</div>
