					...
					<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
						...
						<div class="card-body">
							...
							<div class="a form-group">
								...
								<select class="form-control" name="matiere_emb">
							...
							<div class="a form-group">
								...
								<select class="form-control" name="type_emb">
							...
							<div class="a form-group">
								...
								<input type="number" min="0" class="form-control" name="nbr_emb" value="{{ $data1->nbr_emb }}">
							</div>
					...
					<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
						...
						<div class="card-body">
							...
							<div class="a form-group">
								...
								<select class="form-control" name="matiere_eti">
							...
							<div class="a form-group">
								...
								<select class="form-control" name="type_eti">
							...
							<div class="a form-group">
								...
								<input type="number" min="0" class="form-control" name="nbr_eti" value="{{ $data2->nbr_eti }}">
							</div>
