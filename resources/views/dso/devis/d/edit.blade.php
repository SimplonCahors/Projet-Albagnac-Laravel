				...
				<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
					...
					<div class="card-body">
						...
						<div class="a form-group">
							...
							<input type="text" class="form-control" name="type_machine_amont">
						</div>

						<div class="a form-group">
							<label for="type_convoy_amont">Type de convoyage AMONT</label>
							<input type="text" class="form-control" name="type_convoy_amont">
						</div>

						<div class="a form-group">
							<label for="categorie_client">Transfert AMONT</label>
							<select class="form-control" name="transfert_amont">
						...
						<div class="a form-group">
							...
							<select class="form-control" name="arrivee_prod_amont">
								<option selected>Choisir</option>
						...
						<div class="a form-group">
							...
							<input type="text" class="form-control" name="type_machine_aval">
						</div>

						<div class="a form-group">
							<label for="type_convoy_aval">Type de convoyage AVAL</label>
							<input type="text" class="form-control" name="type_convoy_aval">
						</div>

						<div class="a form-group">
							<label for="transfert_aval">Transfert AVAL</label>
							<select class="form-control" name="transfert_aval">
								<option selected>Choisir</option>
								<option value="Plaque de glissement">Plaque de glissement</option>
								<option value="À rouleaux">À rouleaux</option>
								<option value="À courroies motorisées">À courroies motorisées</option>
						...
						<div class="a form-group">
							...
							<input type="text" class="form-control" name="sortie_prod_aval">
						</div>
						<hr>
						...
						<div class="a form-group">
							...
							<select class="form-control" name="sens_machine">
								<option selected>Choisir</option>
						...
						<div class="a form-group">
							...
							<input type="number" class="form-control" name="cadence_souhaitee" min="0">
						</div>

						<div class="a form-group">
							<label for="milieu">Milieu</label>
							<select class="form-control" name="milieu">
								<option selected>Choisir</option>
						...
						<div class="a form-group">
							...
							<input type="number" class="form-control" name="hauteur_convoyeur" min="0">
						</div>

						<div class="a form-group">
							<label for="espace_au_sol">Espace disponible au sol (m x m)</label>
							<input type="number" class="form-control" name="espace_au_sol" min="0">
						</div>

						<div class="a form-group">
							<label for="temp_local">T° du local de travail (°C)</label>
							<input type="number" class="form-control" name="temp_local">
						</div>
						<hr>						
						...
						<div class="a form-group">
							...
							<select class="form-control" name="comm_machine_amont">
								<option selected>Choisir</option>
						...
						<div class="a form-group">
							...
							<select class="form-control" name="comm_machine_aval">
								<option selected>Choisir</option>
								<option value="Oui">Oui</option>
								<option value="Non">Non</option>
							</select>
						...
						<div class="a form-group">
							...
							<select class="form-control" name="coupure_bourrage">
								<option selected>Choisir</option>
								<option value="Oui">Oui</option>
								<option value="Non">Non</option>
							</select>
						...
						<div class="a form-group">
							...
							<textarea class="form-control" name="descriptif" rows="3" placeholder="descriptif">
							</textarea>
						</div>
					</div>
				...
				<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
					...
					<div class="card-body">
						...
						<div class="a form-group">
							...
							<select class="form-control" name="tension_elec">
								<option selected>Choisir</option>
						...
						<div class="a form-group">
							...
							<select class="form-control" name="reg_de_neutre">
								<option selected>Choisir</option>
						...
						<div class="a form-group">
							...
							<input type="number" class="form-control" name="debit_m3h">
						</div>

						<div class="a form-group">
							<label for="pression_bar">Pression (bar)</label>
							<input type="number" class="form-control" name="pression_bar">
						</div>
				...
				<div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
					...
					<div class="card-body">
						...
						<div class="a form-group">
							...
							<select class="form-control" name="controle_conformite">
								<option selected>Choisir</option>
						...
						<div class="a form-group">
							...
							<select class="form-control" name="demande_fat">
								<option selected>Choisir</option>
								<option value="1">Oui</option>
								<option value="0">Non</option>
							</select>
						...
						<div class="a form-group">
							...
							<input type="date" class="form-control" name="date_desiree_fat">
						</div>

						<div class="a form-group">
							<label for="demande_cem">Demande de CEM (Electromagnetisme)</label>
							<select class="form-control" name="demande_cem">
								<option selected>Choisir</option>
								<option value="1">Oui</option>
								<option value="0">Non</option>
							</select>
						...
						<div class="a form-group">
							...
							<select class="form-control" name="demande_certif_ext">
								<option selected>Choisir</option>
								<option value="1">Oui</option>
								<option value="0">Non</option>
							</select>
				...
				<div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordion">
					...
					<div class="card-body">
						...
						<div class="a form-group">
							...
							<select class="form-control" name="install_client">
								<option selected>Choisir</option>
								<option value="1">Oui</option>
								<option value="0">Non</option>
							</select>
						...
						<div class="a form-group">
							...
							<select class="form-control" name="plan_prevention">
								<option selected>Choisir</option>
								<option value="1">Oui</option>
								<option value="0">Non</option>
							</select>
						...
						<div class="a form-group">
							...
							<select class="form-control" name="mise_en_route">
								<option selected>Choisir</option>
								<option value="1">Oui</option>
								<option value="0">Non</option>
							</select>
				...
				<div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordion">
					...
					<div class="card-body">
						...
						<div class="a form-group">
							...
							<select class="form-control" name="sur_machine">
								<option selected>Choisir</option>
								<option value="1">Oui</option>
								<option value="0">Non</option>
							</select>
						...
						<div class="a form-group">
							...
							<select class="form-control" name="en_salle">
								<option selected>Choisir</option>								
								<option value="1">Oui</option>
								<option value="0">Non</option>
							</select>
						...
						<div class="a form-group">
							...
							<input type="number" class="form-control" name="nombre_jours" min="0">
						</div>

						<div class="a form-group">
							<label for="nombre_personnes">Nombre de personnes</label>
							<input type="number" class="form-control" name="nombre_personnes" min="0">
						</div>
				...
				<div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#accordion">
					...
					<div class="card-body">
						...
						<div class="a form-group">
							...
							<input type="___" class="form-control" name="quantite" min="0">
						</div>
						...
						<div class="a form-group">
							...
							<select class="form-control" name="numerique">
								<option selected>Choisir</option>
								<option value="1">Oui</option>
								<option value="0">Non</option>
							</select>
				...
				<div id="collapseSeven" class="collapse" aria-labelledby="headingSeven" data-parent="#accordion">
					...
					<div class="card-body">
						...
						<div class="a form-group">
							...
							<select class="form-control" name="charge_albagnac">
								<option value="1">Oui</option>
								<option value="0">Non</option>
							</select>
						</div>
