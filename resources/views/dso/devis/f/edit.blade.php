					...
					<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
						...
						<div class="card-body">
							...
							<div class="a form-group">
								...
								<input type="text" class="form-control" name="objet_rem" value="{{ $data->objet_rem }}">
							</div>

							<div class="nouveau-dso form-group">
								<label for="descriptif_rem">Descriptif :</label>
								<textarea type="text" class="form-control" name="descriptif_rem" required>{{ $data->descriptif_rem }}</textarea>
							</div>
