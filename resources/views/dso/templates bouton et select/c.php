...
<div class="Class__Select__Div">
    <button id="___">Matière de l'emballage</button>
...
<div class="Class__Select__Div">
    <button id="___">Type d'emballage</button>
...
<div class="Class__Select__Div">
    <button id="___">Matière de le l'étiquette</button>
...
<div class="Class__Select__Div">
    <button id="___">Type de l'étiquette</button>
