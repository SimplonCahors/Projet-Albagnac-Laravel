	...
	<form action="/dso/{{ $idDso }}/etiquettes/{{ $idEtiquette }}/edit/" method="POST">
		...
		<div id="left">
			<div class="form-group row">
				<div class="col-6">
					<input type="text" class="form-control" id="ref_eti" name="ref_eti" value="{{ $data->ref_eti }}">
				</div>
			...
			<div class="form-group row">
				<div class="col-6">
					<input type="number" class="form-control" id="hauteur_eti" name="hauteur_eti" value="{{ $data->hauteur_eti }}">
				</div>
				<label for="hauteur_eti" class="col-6 col-form-label">Hauteur en mm</label>
			</div>
			<div class="form-group row">
				<div class="col-6">
					<input type="number" class="form-control" id="largeur_eti" name="largeur_eti" value="{{ $data->largeur_eti }}">
				</div>
				<label for="largeur_eti" class="col-6 col-form-label">Largeur en mm </label>
			</div>
			<div class="form-group row">
				<div class="col-6">
					<input type="number" class="form-control" id="diametre_eti" name="diametre_eti" value="{{ $data->diametre_eti }}">
				</div>
		...
		<div id="right">
			...
			<div class="form-group row">
				<div class="col-5">
					<input type="number" class="form-control" id="hauteur_bobine" name="hauteur_bobine" value="{{ $data->hauteur_bobine }}">
				</div>
				<label for="hauteur_bobine" class="col-7 col-form-label">Hauteur (H)</label>
			</div>
			<div class="form-group row">
				<div class="col-5">
					<input type="number" class="form-control" id="diametre_bobine" name="diametre_bobine" value="{{ $data->diametre_bobine }}">
				</div>
				<label for="diametre_bobine" class="col-7 col-form-label">Diamètre bobine (D)</label>
			</div>
			<div class="form-group row">
				<div class="col-5">
					<input type="number" class="form-control" id="diametre_mandrin" name="diametre_mandrin" value="{{ $data->diametre_mandrin }}">
				</div>
				<label for="diametre_mandrin" class="col-7 col-form-label">Diamètre mandrin (d)</label>
			</div>
			<div class="form-group row">
				<div class="col-5">
					<input type="number" class="form-control" id="nbr_eti" name="nbr_eti" value="{{ $data->nbr_eti }}">
				</div>
